...
Labour coefficients: $a_{LR}^{I} = 3$, $a_{LWh}^{I} = 6$; $a_{LR}^{W} = 2$, $a_{LWh}^{W} = 2$.
The **World** has absolute advantage in **both** goods (fewer hours needed per unit).
...
::: {.column width="40%"}
**India:**
$$3R + 6Wh = 600 \;\Rightarrow\; R + 2Wh = 200$$
Slope $= -2$ (give up 2 Rice per Wheat)

**World:**
$$2R + 2Wh = 600 \;\Rightarrow\; R + Wh = 300$$
