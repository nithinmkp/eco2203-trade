...
\title{Lecture 15: SPS Measures and Codex Alimentarius}
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture15_SPS_Codex_files/figure-beamer/fig-codex-standards-1.pdf}}

}

\caption{\label{fig-codex-standards}Codex Alimentarius: Standards
...
\begin{frame}{India's Major SPS Export Challenges}
\phantomsection\label{indias-major-sps-export-challenges}
\begin{columns}[T]
\begin{column}{0.5\linewidth}
\textbf{Product-wise SPS Problems}
...
\midrule\noalign{}
\endhead
Spices (chilli, cumin, pepper) & ETO, chlorpyrifos, aflatoxin & EU,
Singapore, USA \\
Marine products (shrimp, fish) & Chloramphenicol, nitrofurans,
Salmonella & USA, EU, Japan \\
Basmati/non-basmati rice & Tricyclazole, acephate, isoprothiolane &
EU \\
...
India's agricultural exports (2023-24): \textasciitilde{}\textbf{USD 50
billion}

Top export earners at risk: - Marine products: USD 7.4 billion (USA, EU,
Japan) - Rice: USD 10.5 billion (multiple markets) - Spices: USD 4.5
billion (EU, USA, Middle East) - Buffalo meat: USD 3.5 billion (Gulf,
Southeast Asia)

EU RASFF alerts on Indian origin products: \textbf{200+ per year} (among
top 5 source countries for alerts)

FDA import refusals -- India: consistently \textbf{3rd-5th} most refused
country

SPS compliance is the single \textbf{largest non-tariff barrier} to
India's agricultural exports -- more important than tariffs in many
premium markets
\end{column}
\end{columns}
\end{frame}
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture15_SPS_Codex_files/figure-beamer/fig-eu-rasff-1.pdf}}

}

\caption{\label{fig-eu-rasff}EU RASFF Alerts on Indian Food Products
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture15_SPS_Codex_files/figure-beamer/fig-spice-rejection-donut-1.pdf}}

}

\caption{\label{fig-spice-rejection-donut}Reasons for Spice Export
...
\textbf{(a) Prevention (Farm Level)} - GAP (Good Agricultural Practice)
training: Spices Board, APEDA, HORTICULTURE - IPM (Integrated Pest
Management): reduce pesticide dependence - Farmer training on
pre-harvest intervals (PHI) for pesticides - FSSAI Eat Right India: food
safety culture

\textbf{(b) Detection (Testing Infrastructure)} - NABL lab accreditation
expansion - Real-time RASFF monitoring - FSSAI's food safety
surveillance system - Pre-shipment testing mandates (EIC, Spices Board,
MPEDA)
\end{column}

\begin{column}{0.5\linewidth}
\textbf{(c) Certification} - FSSAI accreditation of testing laboratories
...
\textbf{(f) Domestic Policy} - FSSAI alignment with Codex - Pesticide
deregistration (remove banned pesticides from Indian market)
\end{column}
\end{columns}
\end{frame}
