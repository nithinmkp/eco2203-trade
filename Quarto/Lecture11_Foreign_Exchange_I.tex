...
\title[L11 \textbar{} Foreign Exchange I]{Lecture 11: Foreign Exchange
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture11_Foreign_Exchange_I_files/figure-beamer/fig-forex-eq-1.pdf}}

}

\caption{Foreign Exchange Market: Equilibrium
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture11_Foreign_Exchange_I_files/figure-beamer/fig-inr-trend-1.pdf}}

}

\caption{INR/USD Exchange Rate: Key Depreciation
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture11_Foreign_Exchange_I_files/figure-beamer/fig-ppp-india-1.pdf}}

}

\caption{India: Actual Exchange Rate vs PPP-Implied
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture11_Foreign_Exchange_I_files/figure-beamer/fig-irp-1.pdf}}

}

\caption{Uncovered Interest Rate Parity: Expected Return
...
\textbf{Depreciation (e ↑: ₹75→₹85) --- Winners (Exporters):}
...
\textbf{Appreciation (e ↓: ₹85→₹75) --- Winners (Importers):}
...
\note{\textbf{Depreciation losers (input costs rise):} - 🧪 Fertiliser
imports (urea, DAP) cost more - 🛢️ Diesel for tractors/pumps more
expensive - 🌿 Cotton (\textasciitilde\$2B/yr) exporters gain under
depreciation

\textbf{Appreciation losers (exporters squeezed):} - 🧪 Fertilisers:
urea, DAP, MOP cheaper in ₹ terms - Rice, spice, marine, cotton
