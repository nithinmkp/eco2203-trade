...
::: {.columns}
::: {.column width="50%"}
1. **Commercial Invoice** — price, quantity, HSN code, IEC, buyer/seller details; basis for customs valuation
2. **Packing List** — box-by-box itemisation of weight, dimensions, marks
3. **Bill of Lading (B/L)** — title document issued by shipping line; original B/L needed to claim cargo
4. **Airway Bill (AWB)** — air freight equivalent of B/L; non-negotiable consignment note
5. **Certificate of Origin (CoO)** — issued by FIEO/chamber; determines FTA preferential tariff eligibility
:::
::: {.column width="50%"}
::: {.keybox}
The **Bill of Lading** is the only document that is a negotiable instrument — it can be endorsed and transferred like a cheque.
:::
:::
:::
...
::: {.columns}
::: {.column width="50%"}
6. **Phytosanitary Certificate** — issued by PPQS (Plant Protection, Quarantine & Storage); mandatory for all plant products
7. **Health / Inspection Certificate** — issued by EIC for meat, marine, organic, dairy exports
8. **EDPMS declaration** — RBI's online system linking shipment to forex realization
9. **Fumigation Certificate** — mandatory for pulses, oilseeds; issued by certified fumigators
10. **Shipping Bill** — key customs clearance document filed on ICEGATE; must be approved before loading
:::
::: {.column width="50%"}
::: {.methodbox}
**Document flow for a typical agri export:**

1. Export contract signed → Commercial Invoice prepared
2. LC opened by buyer's bank
3. Shipment arranged → B/L issued
4. Phytosanitary + Fumigation certificates obtained
5. Shipping Bill filed on ICEGATE → LEO (Let Export Order) obtained
6. Documents presented to advising bank → payment
7. EDPMS updated → forex realization confirmed
:::
:::
:::
