...
::: {.keybox}
India's overall current account deficit is modest (~1% of GDP) because services surplus and remittances (~\$120B in FY2024) partially offset the merchandise deficit.
:::
...
## Key Concepts We Will Need {.smaller}
...
- **Exchange rate** — price of one currency in terms of another; stronger rupee makes exports more expensive
...
## India's Major Trading Partners (FY2024) {.smaller}
...
- Engineering goods = India's largest export category; grew from 12% (2000) to 26% (2024)
...
::: {.methodbox}
**The core result:** Trade allows a country to **consume beyond its production possibilities** — achieved through specialisation and exchange.
