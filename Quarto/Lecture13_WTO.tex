...
\title[L13 \textbar{} WTO]{Lecture 13: WTO --- Origin, Structure and
Functions}
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture13_WTO_files/figure-beamer/fig-trade-gdp-1.pdf}}

}

\caption{Global Trade vs GDP Growth Index
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture13_WTO_files/figure-beamer/fig-wto-membership-1.pdf}}

}

\caption{WTO Membership Growth (1995-2024)
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture13_WTO_files/figure-beamer/fig-india-wto-disputes-1.pdf}}

}

\caption{India's WTO Dispute Settlement
...
\textbf{Lecture 14 (July 28, 2026):} \textbf{Agreement on Agriculture
(AoA)}
...
\item
  ...
  Export Competition
\item
  Tariffication and Tariff Rate Quotas; the Three Boxes: Green, Blue,
  Amber
\item
...
\item
  India provides fertiliser subsidies worth ₹2.25 lakh crore per year.
  Is this WTO-legal? Which `box' does it fall in? We will work through
  the answer systematically using the AoA framework.
\end{itemize}
