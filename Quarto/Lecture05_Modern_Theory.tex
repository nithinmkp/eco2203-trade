...
\tightlist
\item
  India (labor-abundant) exports Rice; USA (capital-abundant) exports
  Machines; both reach higher IC
\item
  Production: A/A* → B/B* along PPF; consumption: A/A* → E/E* on trade
  line (above PPF)
\end{itemize}
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, opacitybacktitle=0.6, rightrule=.15mm, bottomrule=.15mm, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{The FPE insight}, colback=white, leftrule=.75mm, colbacktitle=quarto-callout-important-color!10!white, opacityback=0, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, titlerule=0mm, breakable, toprule=.15mm, left=2mm, coltitle=black]
