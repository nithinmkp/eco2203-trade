...
\begin{frame}{Basis for and Gains from Trade: H-O Model}
\phantomsection\label{basis-for-and-gains-from-trade-h-o-model}
\begin{columns}[T]
\begin{column}{0.4\linewidth}
\textbf{Autarky (point A):}

\begin{itemize}
\tightlist
\item
  India produces \& consumes at A
\item
  Domestic price ratio \(P_a\): slope \(= -2\) (Rice cheap domestically)
\item
  IC1 tangent to PPF at A
\end{itemize}

\textbf{Free trade (world price \(P_b\), slope \(= -1.5\)):}

\begin{itemize}
\tightlist
\item
  Production shifts to \textbf{B} \((M=60,\, R=160)\)
\item
  India exports \textbf{35 Rice}, imports \textbf{23 Machines}
\item
  Consumption at \textbf{E} \((M=83,\, R=125)\) on IC2
\end{itemize}

\textbf{IC2 \(>\) IC1 → welfare gain}

\emph{Adapted from Salvatore, Fig. 5.4}
\end{column}
...
\caption{Basis for and Gains from Trade under the
H-O Model (after Salvatore Fig. 5.4)}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, colframe=quarto-callout-important-color-frame, left=2mm, opacityback=0, arc=.35mm, leftrule=.75mm, colback=white, bottomtitle=1mm, toprule=.15mm, coltitle=black, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{The FPE insight}, titlerule=0mm, rightrule=.15mm]
