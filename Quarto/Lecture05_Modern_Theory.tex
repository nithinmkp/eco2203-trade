...
\title{Lecture 5: Modern Theories --- Heckscher-Ohlin \& Lewis}
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, left=2mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{The FPE insight}, leftrule=.75mm, coltitle=black, breakable, opacityback=0, bottomrule=.15mm, bottomtitle=1mm, arc=.35mm, rightrule=.15mm, toptitle=1mm, colframe=quarto-callout-important-color-frame, colback=white, titlerule=0mm, toprule=.15mm, opacitybacktitle=0.6]
