...
## India's Major SPS Export Challenges {.smaller}

::: {.columns}
::: {.column width="50%"}
**Product-wise SPS Problems**

| Product | SPS Issue | Key Market |
|---------|-----------|-----------|
| Spices (chilli, cumin, pepper) | ETO, chlorpyrifos, aflatoxin | EU, Singapore, USA |
| Marine products (shrimp, fish) | Chloramphenicol, nitrofurans, Salmonella | USA, EU, Japan |
| Basmati/non-basmati rice | Tricyclazole, acephate, isoprothiolane | EU |
| Fresh grapes | Pesticide MRLs (profenofos) | EU |
| Mangoes | Mango seed weevil, Drosophila | USA, Japan, Korea |
| Peanuts | Aflatoxin (Aspergillus mould) | EU |
| Buffalo meat | Veterinary residues, FMD | Gulf, Southeast Asia |
| Honey | Antibiotic residues, pesticide contamination | EU, USA |
:::
::: {.column width="50%"}
**Scale of the Problem**

::: {.methodbox}
India's agricultural exports (2023-24): ~**USD 50 billion**

Top export earners at risk:
- Marine products: USD 7.4 billion (USA, EU, Japan)
- Rice: USD 10.5 billion (multiple markets)
- Spices: USD 4.5 billion (EU, USA, Middle East)
- Buffalo meat: USD 3.5 billion (Gulf, Southeast Asia)

EU RASFF alerts on Indian origin products: **200+ per year** (among top 5 source countries for alerts)

FDA import refusals -- India: consistently **3rd-5th** most refused country
:::

::: {.highlightbox}
SPS compliance is the single **largest non-tariff barrier** to India's agricultural exports -- more important than tariffs in many premium markets
:::
:::
:::
...
::: {.keybox}
**(a) Prevention (Farm Level)**
- GAP (Good Agricultural Practice) training: Spices Board, APEDA, HORTICULTURE
- IPM (Integrated Pest Management): reduce pesticide dependence
- Farmer training on pre-harvest intervals (PHI) for pesticides
- FSSAI Eat Right India: food safety culture

**(b) Detection (Testing Infrastructure)**
- NABL lab accreditation expansion
- Real-time RASFF monitoring
- FSSAI's food safety surveillance system
- Pre-shipment testing mandates (EIC, Spices Board, MPEDA)
:::
:::
::: {.column width="50%"}
::: {.methodbox}
**(c) Certification**
- FSSAI accreditation of testing laboratories
- EIC health certificates for marine and processed products
- Third-party international certifications

**(d) Bilateral Negotiation**
- Phytosanitary protocols (product-by-product)
- Equivalence agreements
- Bilateral veterinary certificates

**(e) WTO Advocacy**
- Register Specific Trade Concerns (STCs) at WTO SPS Committee
- Challenge scientifically unjustified standards
- Support Codex positions beneficial to India (JMPR, JECFA)
