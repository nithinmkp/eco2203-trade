...
Long distances → higher transport costs, insurance, cold-chain requirements, longer lead times

**(b) Different currencies**
Each transaction requires currency conversion; exchange rate fluctuations create financial risk

**(c) Factor immobility**
Labour and capital cannot move freely across borders — immigration controls, capital account restrictions
:::
::: {.column width="50%"}
**(d) Multiple political jurisdictions**
Each country sets its own trade policy — tariffs, quotas, export bans; no single governing authority

**(e) Different legal systems & culture**
Food labelling laws, packaging standards, contract enforcement vary; Indian spice exporters must comply with EU pesticide MRL standards

**(f) Greater risk and uncertainty**
Combination of all above → higher commercial, political, and exchange-rate risk than domestic commerce
:::
:::
...
- **Labour:** Visa restrictions, language barriers, immigration quotas
  - India sends ~8 million workers to Gulf countries — but under strict bilateral agreements, not free movement
...
::: {.column width="45%"}
::: {.highlightbox}
**India case: Gulf remittances**

Indian workers (largely from Kerala, UP, Bihar) work in UAE, Saudi Arabia, Kuwait — sending back **~\$120 billion in remittances (FY2024)**, making India the world's largest remittance recipient.

This is *partial* factor mobility — workers move but face fixed-term contracts and limited rights.

Remittances are India's largest single source of foreign exchange — larger than IT exports or any single merchandise export category.
:::
:::
:::
...
::: {.column width="45%"}
::: {.methodbox}
**Agricultural export example**

A Punjab wheat exporter quotes **\$250/tonne** FOB Mumbai.

- At ₹80/USD → realises ₹20,000/tonne
- At ₹75/USD (appreciation) → realises only ₹18,750/tonne
- At ₹85/USD (depreciation) → realises ₹21,250/tonne

A **5% INR appreciation = 6.25% reduction** in rupee revenue — potentially wiping out margins on thin-traded commodities.

**Hedging tools:** Forward contracts, futures on NSE/BSE, ECGC insurance
:::
:::
:::
...
Where:
- $T_{ij}$ = trade between country $i$ and country $j$
- $Y_i, Y_j$ = GDP (economic size) of each country
...
**Who gained from the ban:**
- Urban consumers (domestic rice prices stabilised)
- State governments managing food inflation
- RBI's CPI inflation target

**Who lost:**
- Paddy farmers — domestic price fell when export outlet closed
- Rice millers and exporters — contracts cancelled; reputation damage
- Bangladesh, West Africa — importers faced supply shortage; global rice prices rose +20%
:::
::: {.column width="40%"}
::: {.highlightbox}
**Policy outcome:**

The ban caused a **global rice price spike of ~20%** — demonstrating India's market power as the world's dominant rice exporter.

India partially reversed the ban for specific grades in early 2024 under WTO member pressure.
...
::: {.column width="45%"}
::: {.methodbox}
**Why small agri-exporters struggle**

Indian rice exporters to EU must meet **Maximum Residue Levels (MRLs)** for 300+ pesticides. Failure → entire consignment rejected at port.

L/C requires strong banking relationships. MSME spice and horticulture exporters often cannot negotiate L/C terms with large US/EU importers.

**ECGC** provides credit insurance — covers non-payment risk for Indian exporters.
:::
:::
:::
...
- **India's trade openness** rose from 14% of GDP (1990) to 44% (2024) — a dramatic shift driven by 1991 liberalisation
...
- **Edible oil dependence** is India's most significant agricultural import vulnerability: \$12–14B/year, 60–65% of consumption
