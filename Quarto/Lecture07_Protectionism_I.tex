...
\urlstyle{same}
\hypersetup{
  pdftitle={Lecture 7: Protectionism I --- Tariffs \& Quotas},
  pdfauthor={Nithin M},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}


\title[L7 \textbar{} Protectionism I]{Lecture 7: Protectionism I ---
Tariffs \& Quotas}
...
\begin{frame}{Recap: Free Trade and Its Limits}
...
\begin{frame}{Overview of Protectionist Instruments}
...
\begin{frame}{The Case for Protection}
...
\begin{frame}{Baseline: Free Trade Welfare}
...
\caption{Free Trade: Domestic Supply, Demand, and
...
\begin{frame}{Partial Equilibrium Analysis of a Tariff}
...
\begin{frame}{Effect of a Tariff --- Welfare Analysis}
...
\caption{Specific Tariff t=10: CS Lost, PS
...
\begin{frame}{Welfare Accounting: The Tariff Identity}
...
\begin{frame}{Winners and Losers from a Tariff}
...
\begin{frame}{India's Agricultural Tariff Structure}
...
\begin{frame}{India's Agricultural Tariff Profile}
...
\caption{India: Applied MFN Tariff Rates on Key
...
\begin{frame}{The Tariff Rate Quota (TRQ)}
...
\begin{frame}{Case Study: India's Palm Oil Import Duty}
...
\begin{frame}{Effective Rate of Protection (ERP)}
...
\begin{frame}{What is an Import Quota?}
...
\begin{frame}{Import Quota --- Same Effect, Different Mechanism}
...
\caption{Import Quota: Quantity Restriction Creates
...
\begin{frame}{Tariff vs Quota: Revenue vs Rent}
...
\begin{frame}{Tariff vs Quota: Similarities and Differences}
...
\begin{frame}{India's Quantitative Restrictions: History}
...
\begin{frame}{The Optimal Tariff Argument}
...
\begin{frame}{Infant Industry Protection: India's Experience}
...
\begin{frame}{Voluntary Export Restraints (VERs)}
...
\begin{frame}{Non-Tariff Barriers (NTBs): Preview}
...
\begin{frame}{Summary: Tariffs and Quotas}
