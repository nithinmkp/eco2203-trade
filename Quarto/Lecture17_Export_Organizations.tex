...
\title[L17 \textbar{} Export Organizations]{Lecture 17: Agricultural
...
\begin{frame}{The Institutional Architecture of India's Agri Exports}
...
\begin{frame}{APEDA: Mandate and Structure}
...
\begin{frame}{APEDA Scheduled Product Exports: FY2024}
\phantomsection\label{apeda-scheduled-product-exports-fy2024}
\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{Lecture17_Export_Organizations_files/figure-beamer/fig-apeda-products-1.pdf}}

}

\caption{Processed food is the single largest
...
\begin{frame}{APEDA's Key Functions in Practice}
...
\begin{frame}{Top 10 Destinations for India's Agricultural Exports}
\phantomsection\label{top-10-destinations-for-indias-agricultural-exports}
\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{Lecture17_Export_Organizations_files/figure-beamer/fig-agri-destinations-1.pdf}}

}

\caption{USA leads with 11.2\% share driven
...
\begin{frame}{APEDA's Success Metrics: Selected Achievements}
...
\begin{frame}{India Agricultural Exports: Long-run Trend}
\phantomsection\label{india-agricultural-exports-long-run-trend}
\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{Lecture17_Export_Organizations_files/figure-beamer/fig-apeda-trend-1.pdf}}

}

\caption{India's APEDA-promoted exports grew 2.3x
...
\begin{frame}{MPEDA: India's Seafood Export Authority}
...
\begin{frame}{MPEDA: Quality Systems and International Compliance}
...
\begin{frame}{The Five Commodity Boards: Overview}
...
\begin{frame}{Tea Board of India}
...
\begin{frame}{Coffee Board and Spices Board}
...
\begin{frame}{Export Inspection Council (EIC)}
...
\begin{frame}{NAFED: Price Stabilisation and Export Implications}
...
\begin{frame}{Farmer Producer Organizations as Export Units}
...
\begin{frame}{Government Schemes Supporting Agri Export Organizations}
...
\begin{frame}{India's 2030 Agricultural Export Ambition}
\phantomsection\label{indias-2030-agricultural-export-ambition}
\textbf{APEDA's target: \$60 billion by 2030} (from \$43.7B in FY2024;
CAGR \textasciitilde5.4\%)

\textbf{National agri-food export target (FTP 2023--28): \$100 billion
by 2030}
...
GatiShakti nodes 5. Leverage GI brand premiums
...
\note{\textbf{Commodity Board targets:} Spices Board: \$5B (from
\$3.7B); Coffee Board: \$2B (from \$1.2B); Tea Board: \$1.5B (from
\$750M). MPEDA's target: \$12B in seafood.
