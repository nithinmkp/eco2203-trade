...
\urlstyle{same}
\hypersetup{
  pdftitle={Lecture 2: Features of International Trade},
  pdfauthor={Nithin M},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}


\title[L2 \textbar{} Features of International Trade]{Lecture 2:
...
\caption{India: Trade Openness (Exports + Imports
...
\begin{frame}{Feature 1: Factor Immobility (cont.)}
\phantomsection\label{feature-1-factor-immobility-cont.}
...
\note{\textbf{Why small agri-exporters struggle:} Indian rice exporters
to EU must meet \textbf{Maximum Residue Levels (MRLs)} for 300+
pesticides. Failure → entire consignment rejected at port. L/C requires
strong banking relationships. \textbf{ECGC} provides credit insurance
