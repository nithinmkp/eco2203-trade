...
\textbf{Conditions for ICA success:} Large share of world trade covered;
homogeneous commodity; adequate buffer stock financing; commitment from
both producers and consumers; no close substitutes.

\textbf{Why ICAs fail:} (1) Free-rider: non-members export outside quota
at high prices; (2) cheating: members secretly exceed quotas; (3) buffer
stock cost for perishable agri-commodities; (4) technological change
(substitutes undermine demand); (5) North-South conflict: producers want
high prices; consumers want low prices.
