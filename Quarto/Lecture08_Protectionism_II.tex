...
\begin{frame}
\begin{block}{International Commodity Agreements (ICAs): instruments}
...
\begin{frame}
\begin{block}{Why ICAs fail in practice}
...
\begin{frame}
\begin{block}{Tin crisis (1985): why buffer stocks fail}
