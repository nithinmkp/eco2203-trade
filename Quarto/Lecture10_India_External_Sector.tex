...
\begin{block}{Overview of India's External Sector}
...
\begin{block}{Merchandise Exports: Structure FY2024}
...
\begin{block}{Merchandise Export Composition: FY2024}
\phantomsection\label{merchandise-export-composition-fy2024}
\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{Lecture10_India_External_Sector_files/figure-beamer/fig-export-composition-1.pdf}}

}

\caption{\label{fig-export-composition}India's Merchandise Export
...
\begin{block}{Merchandise Imports: Structure FY2024}
...
\begin{block}{Merchandise Import Composition: FY2024}
\phantomsection\label{merchandise-import-composition-fy2024}
\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{Lecture10_India_External_Sector_files/figure-beamer/fig-import-composition-1.pdf}}

}

\caption{\label{fig-import-composition}India's Merchandise Import
Composition, FY2024 (USD billion) Source: DGCI\&S / Ministry of Commerce
and Industry, GoI.}
...
\begin{block}{Agricultural Exports FY2024: Breakdown}
...
\begin{block}{Agricultural Imports FY2024: Breakdown}
...
\begin{block}{India's Net Agricultural Trade Position}
...
\begin{block}{India's Key Merchandise Trading Partners}
...
\begin{block}{India's Trade Partners: FY2024}
\phantomsection\label{indias-trade-partners-fy2024}
\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{Lecture10_India_External_Sector_files/figure-beamer/fig-trade-partners-1.pdf}}

}

\caption{\label{fig-trade-partners}India's Top 5 Export Destinations and
...
\begin{block}{Agricultural Trade Partners}
...
\begin{block}{Services Exports: The Other Engine}
...
\begin{block}{Services Trade Composition: FY2024}
\phantomsection\label{services-trade-composition-fy2024}
\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{Lecture10_India_External_Sector_files/figure-beamer/fig-services-trade-1.pdf}}

}

\caption{\label{fig-services-trade}India's Services Trade Composition,
...
\begin{block}{Remittances: India's Hidden BoP Pillar}
...
\begin{block}{Remittances: Global Comparison}
\phantomsection\label{remittances-global-comparison}
\begin{figure}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{Lecture10_India_External_Sector_files/figure-beamer/fig-remittances-1.pdf}}

}

\caption{\label{fig-remittances}India: World's Largest Remittance
...
\begin{block}{Foreign Direct Investment (FDI) Flows}
...
\begin{block}{Forex Reserves: India's Financial Buffer}
...
\begin{block}{India's 1991 Balance of Payments Crisis}
...
\begin{block}{Current Account Sustainability}
...
\begin{block}{The Edible Oil Vulnerability: A Policy Case Study}
...
\begin{block}{Rice Export Restrictions: A Policy Dilemma}
...
\begin{block}{India's Balance of Payments: Summary Picture}
...
\begin{block}{India's Global Trade Rankings}
...
\begin{block}{Structural Challenges in India's External Sector}
...
\begin{block}{Agricultural Sector's Role in India's External Sector}
...
\begin{block}{Looking Ahead: India's External Sector Goals}
\phantomsection\label{looking-ahead-indias-external-sector-goals}
\textbf{India's trade policy objectives (2025--2030):}

\begin{columns}[T]
\begin{column}{0.55\linewidth}
\textbf{Merchandise targets:} - Merchandise exports target: \textbf{\$1
trillion by FY2030} - Agricultural export target: \textbf{\$100 billion
by 2030} - Electronics exports: \$300B (replace imports)

\textbf{Agricultural priorities:} - Increase oilseed domestic production
(reduce \$14B import bill) - Value-added processed food exports -
Agri-GI tags to premium global markets
\end{column}

\begin{column}{0.45\linewidth}
\textbf{Structural shifts underway:}
...
\begin{block}{Key Takeaways --- Lecture 10}
...
\begin{block}{Next Lecture: Foreign Exchange Rates and Determination}
\phantomsection\label{next-lecture-foreign-exchange-rates-and-determination}
\begin{columns}[T]
\begin{column}{0.6\linewidth}
\textbf{Lecture 11 (July 7, 2026):}

\emph{Foreign Exchange --- Rates and Determination}
...
\begin{column}{0.4\linewidth}
\textbf{Connecting to today:}

Today's external sector data (the flows --- exports, imports,
remittances) determine \textbf{tomorrow's exchange rate.}

Understanding the rate is the next step to understanding how agri trade
