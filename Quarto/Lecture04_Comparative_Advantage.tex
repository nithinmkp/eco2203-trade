...
\urlstyle{same}
\hypersetup{
  pdftitle={Lecture 4: Theories of Trade II --- Comparative Advantage},
  pdfauthor={Nithin M},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}


\title[L4 \textbar{} Comparative Advantage]{Lecture 4: Theories of Trade
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, titlerule=0mm, breakable, bottomrule=.15mm, coltitle=black, arc=.35mm, bottomtitle=1mm, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Key takeaway}, rightrule=.15mm, left=2mm, opacityback=0, leftrule=.75mm, colframe=quarto-callout-note-color-frame]
...
\caption{Production Possibility Frontiers: India and
...
The trade possibilities line starts at full specialisation (0, 200) with
slope \(= -1.5\) (less steep in absolute value than the PPF slope
\(-2\)).
...
\caption{India: Gains from Trade --- Consuming Beyond
...
→ 200 Rice, trades \(\approx 100\) Rice for \(\approx 67\) Wheat:
\[(Wh, R) \approx (67, 100)\]

\textbf{Welfare gain:} 17 more units of Wheat at the same Rice --- the
\textbf{real wage} of Indian workers rises.

\textbf{The algebra:} budget constraint under trade:
\(R + 1.5 \cdot Wh = 200\)
...
\caption{Free Trade Equilibrium: IC tangent to Trade
...
\caption{India: Revealed Comparative Advantage in
...
\textbf{Empirical verdict:} Labour productivity differences strongly
predict export patterns --- Costinot et al.~(2012) find R² ≈ 0.9 across
countries. India's rice exports (RCA = 4.8) confirm comparative
advantage. Complete specialisation is rarely observed in practice, and
short-run distributional losses are documented --- but aggregate welfare
gains are robust.
