...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, leftrule=.75mm, opacityback=0, colframe=quarto-callout-note-color-frame, arc=.35mm, bottomtitle=1mm, colback=white, toptitle=1mm, titlerule=0mm, toprule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Key takeaway}, breakable, opacitybacktitle=0.6, coltitle=black]
