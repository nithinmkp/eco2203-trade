...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Key takeaway}, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, leftrule=.75mm, opacitybacktitle=0.6, bottomtitle=1mm, coltitle=black, toprule=.15mm, arc=.35mm, rightrule=.15mm, colback=white, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, toptitle=1mm, breakable]
