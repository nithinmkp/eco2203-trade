...
\title{Lecture 4: Theories of Trade II --- Comparative Advantage}
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Key takeaway}, colbacktitle=quarto-callout-note-color!10!white, bottomtitle=1mm, arc=.35mm, left=2mm, opacitybacktitle=0.6, colback=white, breakable, toptitle=1mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, leftrule=.75mm, rightrule=.15mm, opacityback=0, toprule=.15mm, bottomrule=.15mm, coltitle=black]
