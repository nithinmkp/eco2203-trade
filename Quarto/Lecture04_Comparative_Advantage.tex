...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, bottomtitle=1mm, breakable, rightrule=.15mm, coltitle=black, colframe=quarto-callout-note-color-frame, titlerule=0mm, left=2mm, toprule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Key takeaway}, colbacktitle=quarto-callout-note-color!10!white, bottomrule=.15mm, arc=.35mm, leftrule=.75mm, colback=white, opacitybacktitle=0.6]
...
\textbf{Empirical support:} Golub \& Hsieh (2000) and Costinot et
al.~(2012) find strong evidence that labour productivity differences
predict export patterns across countries.
...
\tightlist
\item
  Predicts complete specialisation (rarely observed); says nothing about
  \emph{who} within a country gains or loses
\item
