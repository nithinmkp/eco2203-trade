...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colback=white, leftrule=.75mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Key takeaway}, breakable, bottomtitle=1mm, bottomrule=.15mm, toptitle=1mm, arc=.35mm, opacityback=0, toprule=.15mm, titlerule=0mm, colframe=quarto-callout-note-color-frame, rightrule=.15mm, opacitybacktitle=0.6]
